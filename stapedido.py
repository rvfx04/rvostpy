...
query = f"""
    SELECT
        ...
        WHERE
            ...
            #AND (CASE WHEN ISDATE(a.dtFechaEntrega) = 1 THEN CONVERT(DATE, a.dtFechaEntrega) ELSE NULL END) BETWEEN '01-07-2023' AND '31-12-2024'
            AND a.dtFechaEntrega between '01-07-2023' AND '31-12-2024'       
    """
